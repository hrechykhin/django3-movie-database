    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('world_premiere', models.DateField(blank=True, null=True, verbose_name='World release')),
                ('budget', models.PositiveIntegerField(default=0, help_text='Please mention in $', verbose_name='Budget')),
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='Please mention in $', verbose_name='US Box office')),
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='Please mention in $', verbose_name='World Box office')),
